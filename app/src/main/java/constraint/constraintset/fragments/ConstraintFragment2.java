...
public class ConstraintFragment2 extends Fragment {

    private static final String TAG = ConstraintFragment2.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //View v = inflater.inflate(R.layout.circuit, container, false);
    ...
    private void showContent() {
        show = true;
        //updateConstraints(R.layout.circuit_detail);
        updateConstraints(R.layout.fragment_trans_alt);
    }

    private void hideContent() {
        show = false;
        //updateConstraints(R.layout.circuit);
        updateConstraints(R.layout.fragment_trans);
    }
}